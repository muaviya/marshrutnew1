...
- (void)viewDidLoad
{
    ...
    [dict setObject:@"1a.png" forKey:@"1а"];
    [dict setObject:@"1k.png" forKey:@"1 как трол"];
    [dict setObject:@"2k.png" forKey:@"2 как трол"];
    [dict setObject:@"2.png" forKey:@"2"];
    [dict setObject:@"3.png" forKey:@"3"];
    [dict setObject:@"3a.png" forKey:@"3а"];
    [dict setObject:@"3b.png" forKey:@"3б"];
    [dict setObject:@"4.png" forKey:@"4"];
     [dict setObject:@"4a.png" forKey:@"4а"];
    ...
    [dict setObject:@"11k.png" forKey:@"11 как трол"];
    [dict setObject:@"11.png" forKey:@"11"];
    [dict setObject:@"11a.png" forKey:@"11а"];
    [dict setObject:@"12.png" forKey:@"12"];
    [dict setObject:@"12a.png" forKey:@"12а"];
    [dict setObject:@"13a.png" forKey:@"13а"];
    [dict setObject:@"15.png" forKey:@"15"];
    [dict setObject:@"15a.png" forKey:@"15а"];
    [dict setObject:@"15b.png" forKey:@"15б"];
    ...
    [dict setObject:@"20a.png" forKey:@"20а"];
    [dict setObject:@"21.png" forKey:@"21"];
    [dict setObject:@"21a.png" forKey:@"21а"];
